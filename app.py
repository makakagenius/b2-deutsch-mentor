...
# Когда запустишь на компьютере — оставь ключ в кавычках.
# Когда будешь деплоить в интернет — заменим на st.secrets["API_KEY"]
...
translations = {
    ...
    "Italiano": {"title": "Mentore B2", "sidebar_lang": "Lingua:", "sidebar_topic": "Argomento:", "custom_topic": "Altro...", "input_label": "Testo:", "button": "Verifica", "status": "Analisi...", "placeholder": "Gentili...", "own_topic_label": "Inserisci argomento:"}
}
